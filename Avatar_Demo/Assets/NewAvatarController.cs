...
public class NewAvatarController : MonoBehaviour
{
    ...
    /* public Transform Head;
     ...
     public Transform Hips_root;
     public Transform Hips;
     public Transform Shoulder_Right;
     public Transform Shoulder_Left;
     public Transform UpperArm_Right;
     public Transform UpperArm_Left;
     public Transform ElbowArm_Left;
     public Transform ElbowArm_Right;
     public Transform LowerArm_Right;
     public Transform LowerArm_Left;
     public Transform WristArm_Right;
     public Transform WristArm_Left;
     public Transform Hand_Right;
     public Transform Hand_Left;
     public Transform UpperLeg_Right;
     public Transform UpperLeg_Left;
     public Transform KneeLeg_Right;
     public Transform KneeLeg_Left;
     public Transform LowerLeg_Right;
     public Transform LowerLeg_Left;
     public Transform AnkleLeg_Right;
     public Transform AnkleLeg_Left;
     public Transform Foot_Right;
     public Transform Foot_Left;
     public Transform Toe_Right;
     public Transform Toe_Left;
     */
    ...
    public Renderer rend; //we are rendering the joints of the avatar;
    ...
    public void Awake()
    {
        ...
        rend.enabled = true; //makes the renderered 3d object visable if enabled;
    }
    ...
    protected void MoveAvatar(uint UserID)
    {
        ...
        // Change color of the bones;
        if (targetPos != initialPosition)
        {
            // For each bone that was defined, change mesh color.
            for (int i = 0; i < bones.Length; i++)
            {
                ...
                if (bones[i] != null)
                {
                    if (bones[i].gameObject.activeSelf)
                    {
                        ...
                        print(index);
                        changeColorOfAvatar(materials[1], i); //red;
                        //MeshRenderer rend = bones[i].gameObject.GetComponent<MeshRenderer>();
                        //rend.material.shader = Shader.Find("Specular");
                        //rend.material.SetColor("_SpecColor", Color.red); //change mesh color to red;
                    }
                }
            }
        }
        ...
        {
           //for each bone that was defined, maintain mesh color;
           for(int i = 0; i < bones.Length; i++)
           {
              ...
              else
              {
                  ...
                  {
                      bones[i].gameObject.SetActive(true);
                      changeColorOfAvatar(materials[0], i); //green;
                  }
              }
            }
        }
    ...
    public void changeColorOfAvatar(Material mat, int boneIndex)
    {
        bones[boneIndex].gameObject.GetComponent<Renderer>().material = mat;
    }
